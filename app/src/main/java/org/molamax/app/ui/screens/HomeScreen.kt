                ...
                Modifier
                    ...
                    .background(
                        Brush.verticalGradient(
                            listOf(
                                MolaDark,
                                androidx.compose.ui.graphics.Color(0xFF26301F)
                            )
                        )
                    )
                    .padding(20.dp)
        ...
        item {
            Column(Modifier.padding(18.dp)) {
                ...
                FeatureRow(
                    "\uD83C\uDF3F",
                    "Organic solutions",
                    "Targeted support for digestion, immunity and productivity."
                )

                FeatureRow(
                    "\uD83E\uDDEA",
                    "Technical support",
                    "Practical answers for your herd or flock."
                )

                FeatureRow(
                    "\uD83D\uDCCD",
                    "Regional reach",
                    "Zimbabwe and Botswana stockist network."
                )
            }
        }
